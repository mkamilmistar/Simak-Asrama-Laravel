                            ...
                            <div class="isitambah">
                                <form action="/jenis-amalan/{{ $jenisAmalan->id }}/update" method="POST">
                                    ...
                                    <table class="table-bio">
                                        <tr>
                                            <th>Jenis Amalan</th>
                                            <td> <input value="{{ $jenisAmalan->jenisAmalan }}" name="jenisAmalan"
                                                    class="form-control @error('jenisAmalan') is-invalid @enderror"
                                                    type="text">
                                                @error('jenisAmalan')
                                                    <span
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea name="keterangan"
                                                    class="form-control @error('keterangan') is-invalid @enderror">{{ $jenisAmalan->keterangan }}</textarea>
                                                @error('keterangan')
                                                    <span
                                                        class="invalid-feedback d-block"><strong>{{ $message }}</strong></span>
                                                @enderror
                                        ...
                                        <tr>
                                            <th>Bobot Amalan</th>
                                            <td> <input value="{{ $jenisAmalan->bobotAmalan }}" name="bobotAmalan"
                                                    class="form-control @error('bobotAmalan') is-invalid @enderror"
                                                    type="text">
                                                @error('bobotAmalan')
                                                    <span
                                                        class="invalid-feedback d-block"><strong>{{ $message }}</strong></span>
