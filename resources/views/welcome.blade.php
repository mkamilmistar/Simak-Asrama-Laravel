...
<head>
    ...
    <title>Beranda | Sistem Informasi Asrama SCB</title>
...
<body>
    ...
    <script src="{{asset('sites//assets/js/init/weather-init.js')}}"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="{{asset('sites/assets/js/init/fullcalendar-init.js')}}"></script>
