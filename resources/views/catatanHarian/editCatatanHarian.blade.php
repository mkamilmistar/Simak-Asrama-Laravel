                    ...
                    <div class="card-body">
                        <div class="panel">
                            <div class="panel-body">
                                <form action="/catatan-harian/{{ $catatanHarian->id }}/update" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="siswa_id" class="form-control" id="siswa_id">
                                            @foreach($data_siswa as $siswa)
                                                <option value="{{ $siswa->id }}" @if($siswa->id ==
                                                    $catatanHarian->siswa_id) selected @endif>{{ $siswa->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="pembina_id" class="form-control" id="pembina_id">
                                            @foreach($data_guru as $guru)
                                                <option value="{{ $guru->id }}" @if($guru->id ==
                                                    $catatanHarian->guru_id) selected @endif>{{ $guru->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" class="form-control" id="exampleFormControlSelect1">
                                            <option value="Prestasi" @if($catatanHarian->kategori == 'Prestasi')
                                                selected @endif>Prestasi</option>
                                            <option value="Indisipliner" @if($catatanHarian->kategori == 'Indisipliner')
                                                selected @endif>Indisipliner</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1"
                                            rows="3"
                                            placeholder="Keterangan tindakan/kejadian">{{ $catatanHarian->deskripsi }}</textarea>
                                    </div>
